...
if __name__ == "__main__":
    ...
    parser.add_argument("--load-checkpoint", type=bool, default=False, help="Load from a checkpoint before training")
    parser.add_argument("--checkpoint-file", type=str, default=False, help="Checkpoint file to load before training")
    ...
    if load_checkpoint:
        ...
        if checkpoint_file is None:
            print("Must specify checkpoint file if loading checkpoint")
            exit(1)
    ...
    try:
        ...
        max_lr = 6e-4
        min_lr = max_lr * 0.1
        warmup_steps = 715 # GPT2 Warms up till 375 million tokens => 375e6 / 2**19 = 715
        max_steps = 19073 # 10 billion tokens to train / 2**19 tokens per step = 19073
        ...
        for step in range(max_steps):
            ...
            if master_process and ((step >= 0 and step % 250 == 0) or last_step):
                model.eval()
